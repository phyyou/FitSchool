...
>((props, forwardedRef) => {
  ...
  const textCss: Record<HeadingSizeVariants, CSS> = {
    1: { fontWeight: 500, lineHeight: "20px", "@bp2": { lineHeight: "24px" } },
    2: { fontWeight: 500, lineHeight: "24px", "@bp2": { lineHeight: "32px" } },
    3: { fontWeight: 500, lineHeight: "32px", "@bp2": { lineHeight: "48px" } },
    4: { fontWeight: 500, lineHeight: "48px", "@bp2": { lineHeight: "64px" } },
  };
